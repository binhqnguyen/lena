...
##### paging ######
grep "paging_delay" TCP_LOG | awk '{print substr($1, 1, length($1)-1), $2, $4, $5, $6, $7, $8, $9, $10, $11}' > paging.dat
##### application start/stop ####
grep "start at" TCP_LOG | awk '{ print substr($1, 1, length($1)-1), $2, $4, $5, substr($6,2,length($6)-5)}' > application-start.dat
grep "stop at" TCP_LOG | awk '{ print substr($1, 1, length($1)-1), $2, $4, $5, substr($6,2,length($6)-5)}' > application-stop.dat
