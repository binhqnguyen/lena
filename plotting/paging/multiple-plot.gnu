...
plot "cubic-".ue.".dat" using 3:10 title "CWnd" with line lt 1 lc 1 lw 3,\
"cubic-".ue.".dat"  using 3:14 title "Ssthreshold" with line lt 2 lc 2 lw 3
#"application-start.dat" using ($1+$5/1000000000):(50) title "TCP resumes" pt 1 lt 12
#"tcp_send-".ue.".dat" using 1:12 title "TCP delay" with lines lt 4 lw 2 axis x1y2
#"cubic-".ue.".dat" using 3:($54*1000) title "rto" with lines lt 5 lw 2 axis x1y2
...
plot "tcp_send-".ue.".dat" using 1:3 title "TCP goodput" with lines lt 6 lw 3
...
set ylabel "Delay (ms)"
#set y2label "Delay (ms)"
set output "delay_rto-".ue."-".x1."-".x2.".svg"
#set y2tics nomirror tc lt 2
#set y2range [0:800]
#set yrange [0:1200]
set xrange [x1:x2]
