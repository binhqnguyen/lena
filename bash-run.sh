...
./x2-auto-ho-a2a4 a2a4_rlcam_newlossless_no_ctrerror 200 300 0 radio

##a3 with ctr-error=0
echo "running a3 rlcam newlossless ctr-error..."
./x2-auto-ho-a3 a3_rlcam_newlossless_no_ctrerror 200 300 0 radio
...
./x2-auto-ho-a2a4 a2a4_rlcum_newlossless_no_ctrerror 200 300 0 radio

##a3 with ctr-error=0
echo "running a3 rlcum newlossless  ctr-error..."
./x2-auto-ho-a3 a3_rlcum_newlossless_no_ctrerror 200 300 0 radio
