...
struct tcphdr {
 ...
 __u16 res1:4,
  ...
  ece:1,
  cwr:1;
# 57 "linux-2.6.26/include/linux/tcp.h"
 __be16 window;
 __sum16 check;
 __be16 urg_ptr;
};
...
# 108 "linux-2.6.26/include/linux/tcp.h"
enum tcp_ca_state
{
 TCP_CA_Open = 0,
...
extern int inet_csk_compat_setsockopt(struct sock *sk, int level, int optname,
          char *optval, int optlen);
# 182 "linux-2.6.26/include/linux/tcp.h" 2
...
# 183 "linux-2.6.26/include/linux/tcp.h" 2
...
# 411 "linux-2.6.26/include/linux/tcp.h"
};
