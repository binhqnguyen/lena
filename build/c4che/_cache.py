...
NS3_EXECUTABLE_PATH = ['/var/tmp/ns3/build/src/emu', '/var/tmp/ns3/build/src/fd-net-device', '/var/tmp/ns3/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-redhat-linux/4.4.7', '/var/tmp/ns3/nsc/linux-2.6.26', '/var/tmp/ns3/build']
...
VALGRIND_FOUND = True
VERSION = '3-dev'
WITH_NSC = '/var/tmp/ns3/nsc'
WL_SONAME_SUPPORTED = True
cfg_files = ['/var/tmp/ns3/build/ns3/config-store-config.h', '/var/tmp/ns3/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
