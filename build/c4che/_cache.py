...
NS3_EXECUTABLE_PATH = ['/var/tmp/lena_dev2/build/src/emu', '/var/tmp/lena_dev2/build/src/fd-net-device', '/var/tmp/lena_dev2/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-redhat-linux/4.4.7', '/var/tmp/lena_dev2/nsc/linux-2.6.26', '/var/tmp/lena_dev2/build']
...
VALGRIND_FOUND = True
VERSION = '3-dev'
WITH_NSC = '/var/tmp/lena_dev2/nsc'
WL_SONAME_SUPPORTED = True
cfg_files = ['/var/tmp/lena_dev2/build/ns3/config-store-config.h', '/var/tmp/lena_dev2/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
